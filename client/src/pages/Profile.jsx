            ...
            <div className="flex flex-col gap-10 h-dvh items-center justify-center">
                <div className="flex gap-10">
                    <div className="p-10 bg-accent rounded-xl text-white min-h-96">
                        ...
                        {/* user display name */}
                        <p className="text-2xl font-medium mt-3">{user?.displayName}</p>
                        <p className="text-xl font-medium">About:</p>
                        {/* replace with actual about from db */}
                        <p>Science Enthusiast, Environmentalist</p>
                    </div>
                    <div className="grid grid-cols-2 gap-5">
                        {/* replace with stats for each */}
                        <ProfileStats title={"Followers"} stat={9860}></ProfileStats>
                        <ProfileStats title={"Following"} stat={13435}></ProfileStats>
                        <ProfileStats title={"Communities"} stat={531}></ProfileStats>
